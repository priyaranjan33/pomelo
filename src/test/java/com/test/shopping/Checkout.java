...
import com.test.driver.ChromeDriverConfig;
...
public class Checkout{
	...
	void setup() {
		...
		wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(60L))
	...
	@Test
	public void validateaQuantity() throws InterruptedException {
		...
		WebElement element = WaitUntilElement("//*[@id='header-search-form']");
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", element);

		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//input[@placeholder = 'What are you looking for today?...']")))
				.click();
		...
		// Product View
		WaitUntilElement("//div[@class='product-image__hover']//img[@alt='Short Sleeve Mandarin Collar Dress - Pink']")
				.click();
	...
	public void validateDelete() throws InterruptedException {
		...
		WebElement elementSearch = WaitUntilElement(
				"//li[@class='jsx-4161721015 header-section__ul-icon-search']//img[@src='https://pomelo-web-s3.pomelofashion.com/www/6.172.0/static/img/icons/system/search.svg']");
		executor.executeScript("arguments[0].click();", elementSearch);
		WebElement element2 = WaitUntilElement("//*[@id='header-search-form']");

		executor.executeScript("arguments[0].click();", element2);

		WebElement element3 = WaitUntilElement("//input[@placeholder = 'What are you looking for today?...']");
		...
		// Product View
		WebElement element4 = WaitUntilElement(
				"//div[@class='product-image__hover']//img[@alt='Short Sleeve Mandarin Collar Dress - Pink']");
